...
Case of 
	...
	: ($evt=On Data Change:K2:15)
		...
		Form:C1466.currentInvoice.rate:=Form:C1466.currentInvoice.amount_payed/Form:C1466.currentInvoice.amount_invoiced
		  ...
		  //Case of 
		  //: (Form.currentInvoice.currency#"Frs") & (Form.currentInvoice.type="debit")  //calc rate
		  //Form.currentInvoice.rate:=Form.currentInvoice.amount_payed/Form.currentInvoice.amount_invoiced
		
		  //: (Form.currentInvoice.currency#"Frs") & (Form.currentInvoice.type="credit")  //calc rate
		  //Form.currentInvoice.rate:=Form.currentInvoice.amount_payed/Form.currentInvoice.amount_invoiced
